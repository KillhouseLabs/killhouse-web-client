...
export const serverEnv = {
  ...
  GITLAB_SELF_URL: () => process.env.GITLAB_SELF_URL,
  GITLAB_SELF_CLIENT_ID: () => process.env.GITLAB_SELF_CLIENT_ID,
  GITLAB_SELF_CLIENT_SECRET: () => process.env.GITLAB_SELF_CLIENT_SECRET,
