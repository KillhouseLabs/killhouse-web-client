      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <section className="mt-8">
          ...
          <p className="mt-2 text-muted-foreground">
            Killhouse는 서비스 제공을 위해 다음과 같은 개인정보를 수집합니다:
          </p>
          <ul className="mt-2 list-disc space-y-2 pl-6 text-muted-foreground">
            ...
            <li>
              <strong>OAuth 연동 시:</strong> OAuth 제공자로부터 전달받는 프로필
              정보 (이메일, 이름, 프로필 이미지)
            </li>
            <li>
              <strong>저장소 연동 시:</strong> GitHub/GitLab 저장소 접근 토큰
              (분석 시에만 사용)
            </li>
            <li>
        ...
        <section className="mt-8">
          ...
          <p className="mt-2 text-muted-foreground">
            개인정보는 회원 탈퇴 시 즉시 삭제됩니다. 단, 관계 법령에 따라 보관이
        ...
        <section className="mt-8">
          ...
          <p className="mt-2 text-muted-foreground">
            이용자의 저장소 코드는 분석 시에만 일시적으로 처리되며, 분석 완료 후
            코드 원본은 즉시 삭제됩니다. 분석 결과(취약점 리포트)는 이용자가
            프로젝트를 삭제할 때까지 보관됩니다.
          </p>
        </section>
        ...
        <section className="mt-8">
          ...
          <p className="mt-2 text-muted-foreground">
            위 권리 행사는 마이페이지에서 직접 처리하거나 고객센터를 통해 요청할
            수 있습니다.
          </p>
        </section>
        ...
        <section className="mt-8">
          ...
          <p className="mt-2 text-muted-foreground">
            회사는 서비스 제공을 위해 쿠키를 사용합니다. 쿠키는 로그인 상태 유지
            및 서비스 이용 편의를 위해 사용되며, 이용자는 브라우저 설정을 통해
            쿠키 저장을 거부할 수 있습니다.
          </p>
        </section>
        ...
        <section className="mt-8">
          <h2 className="text-xl font-semibold">10. 개인정보처리방침의 변경</h2>
          <p className="mt-2 text-muted-foreground">
