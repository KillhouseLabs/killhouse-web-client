        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <section className="mt-8">
              ...
              <ul className="mt-2 list-disc space-y-2 pl-6 text-muted-foreground">
                <li>
                  서비스는 무료(Free), 프로(Pro), 엔터프라이즈(Enterprise)
                  플랜으로 구분되며, 각 플랜의 기능과 이용 한도는 가격 페이지에
                  안내된 바를 따릅니다.
                </li>
                <li>
                  유료 플랜의 결제는 신용카드, 체크카드 등 회사가 지정한
                  결제수단을 통해 이루어지며, PG사(PortOne)를 통해 안전하게
                  처리됩니다.
                </li>
                <li>
            ...
            <section className="mt-8">
              ...
              <ul className="mt-2 list-disc space-y-2 pl-6 text-muted-foreground">
                <li>
                  이용자는 결제일로부터 7일 이내에 청약철회를 요청할 수 있으며,
                  이 경우 결제 금액 전액을 환불받을 수 있습니다.
                </li>
                <li>
                  결제일로부터 7일이 경과한 후에는 사용일수를 기준으로
                  일할계산하여 남은 기간에 해당하는 금액을 환불합니다. 환불
                  금액은 100원 단위로 절사됩니다.
                </li>
                <li>
            ...
            <section className="mt-8">
              ...
              <ul className="mt-2 list-disc space-y-2 pl-6 text-muted-foreground">
                <li>
                  이용자는 언제든지 구독을 해지할 수 있습니다. 해지는 서비스 내
                  구독 관리 페이지에서 즉시 처리됩니다.
                </li>
                <li>
                  구독 해지 시 현재 결제 기간이 종료될 때까지 서비스를 계속
                  이용할 수 있으며, 다음 결제일에 자동 갱신이 중지됩니다.
                </li>
                <li>
                  해지 후 이용자의 프로젝트 및 분석 데이터는 30일간 보관된 후
                  삭제됩니다. 보관 기간 내에 구독을 재개하면 데이터가
                  복원됩니다.
                </li>
              </ul>
            </section>
